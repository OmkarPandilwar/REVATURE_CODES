...
public class AppDbContext : DbContext
{
    ...
    /*“These DbSet properties tell EF Core to create tables for each entity in my database — Customers, Segments, Contacts, Addresses, Interactions, etc.
Each DbSet basically represents one table.
When EF Core runs, it uses these DbSets to generate SQL tables and allow me to query them using LINQ.”
        */
